...
<!--          </ul>-->
  ...
  <div class="proficiency-main-nav">
    <nav class="navbar navbar-default navbar-wp">
      <div class="container-fluid">
          <div class="row">
              <div class="col-lg-3"><div class="navbar-header">
                      <div class="logo">
                          <div class="row">
                              <div class="col-lg-12">
                                  <!-- Logo -->
                              ...
                              <div class="col-lg-12">
                                  <p>Пока другие говорят о достоинстве своей мебели - мы ее делаем!</p>
                              </div>
                          </div>
                      </div>

                  </div></div>
              <div class="col-lg-6"><div class="collapse navbar-collapse" id="navbar-wp">
              ...
              <div class="col-lg-3">
                  <div class="row">
                      <div class="col-lg-12"><div class="btn-header"><button>Заказать замер</button></div></div>
                      <div class="col-lg-12 head-phone">
